...
Please note that the majority of the coding work presented at SICSS-Amsterdam 2024 will employ **R (will it?)**. You are welcome to employ a language of your choice, such as Python, Julia, or other languages that are commonly used by computational social scientists.  However, we cannot provide much support for those languages.
