...
Participants will get an introduction to working with [LISS](https://www.lissdata.nl/) and [FIRMBACKBONE](https://firmbackbone.nl/) data, where they’ll be able to see the full potential of administrative data, high performance computing and intensively linked data. Participants will also be guided on how to develop their ideas into large projects and learn how ODISSEI infrastructure can be adapted to their own needs. During the SICSS-ODISSEI programme, participants will get lectures from colleagues at ODISSEI member organisations on topics such as Large Language Models, Machine Learning, and Causal Analysis and apply these in hands-on workshops. 
...
During the first week, the following topics will be covered: Introduction to ODISSEI, Machine learning, Large Language Models, and Causal Analysis. In the second week of the summer school, participants will be able to make full use of the ODISSEI infrastructure using the FIRMBACKBONE and LISS data. They will be put into teams and challenged to develop research projects using the full scope and scale of the infrastructure. 
