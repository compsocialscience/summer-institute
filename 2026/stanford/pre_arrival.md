...
The Summer Institute will bring together people from many fields and backgrounds. In order to use our time together efficiently, there are a number of things that you should do before participating in SICSS-Stanford 2026.
...
The majority of the code presented at SICSS-Stanford 2026 will use Python. We recommend the participants have basic working knowledge and experience with using Python prior to arriving (e.g., able to run a Python script or Jupyter notebook on your computer). You are welcome to employ a language of your choice, such as R, Julia, or other languages that are commonly used for data science, however, we cannot support all these languages.

Independent of any language, we recommend adopting an [Integrated Development Environment (IDE)](https://realpython.com/python-ides-code-editors-guide/) for writing and running code, and recommend getting familiar with your IDE and the terminal/shell/console before arriving. For SICSS-Stanford 2026, we will primarily use [Visual Studio Code](https://code.visualstudio.com/). If you've never heard of an IDE or a terminal, we recommend reading:
- Kieran Healy's [Modern Plain Text Computing](https://mptc.io/content), specifically Topics 01, 03, and 08, which provide a gentle introduction to the terminal, text editors, other useful tools, and git for version control.
...
- [Inspect Element](https://inspectelement.org/), an open source resource for [building your own datasets](https://inspectelement.org/build-your-own-datasets.html) that introduces techniques, tools, and considerations that we will explore.
...
If you prefer to pursue learning R, the [SICSS Boot Camp](https://sicss.io/boot_camp) is an online training program created by Chris Bail to provide you with beginner level skills in coding so that you can follow the more advanced curriculum we teach at SICSS. The videos and materials are designed for complete beginners and are best viewed as a sequence since each video builds upon content introduced in previous tutorials. If you are already familiar with the topics in these videos, you do not need to complete them.
