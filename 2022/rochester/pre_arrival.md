...
Please note that the majority of the coding work presented at SICSS-University of Rochester will employ R. You are welcome to employ a language of your choice, such as Python, Julia, or other languages that are commonly used by computational social scientists.  However, we cannot support those languages.
