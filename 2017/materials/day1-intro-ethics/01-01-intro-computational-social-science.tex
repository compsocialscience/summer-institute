...
\includegraphics[width=0.3\textwidth]{figures/provost_data_2013_title.png}\\
\tiny{\textcolor{blue}{\url{https://doi.org/10.1089/big.2013.1508}}}
\end{center}
\pause
\begin{itemize}
\item lots of engineering
\pause
\item certain kinds of problems (e.g., churn) are not as far from social science as they appear
\end{itemize}
