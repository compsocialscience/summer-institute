...
\begin{itemize}
\item 9:15am: Lecture 
\item 11am: Create and deploy survey on MTurk 
\item Lunch (no livestream)
\item Analysis (no livestream)
\item Share results (no livestream)
\item 4pm: Guest speaker: David Lazar
\item dinner
\end{itemize}
...
\begin{center}
\includegraphics[width=0.9\textwidth]{figures/bitbybit3-2_representation_errors}
\end{center}
\pause
