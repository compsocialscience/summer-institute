...
\begin{center}
\only<1>{\includegraphics[width=0.6\textwidth]{figures/salganik_measuring_2020_fig3b}} %
\only<2>{\includegraphics[width=0.9\textwidth]{figures/salganik_measuring_2020_fig3bd}} %
\end{center}
...
\begin{center}
\only<1>{\includegraphics[width=0.6\textwidth]{figures/salganik_measuring_2020_fig3e}} %
\only<2>{\includegraphics[width=0.9\textwidth]{figures/salganik_measuring_2020_fig3eg}} %
\end{center}
