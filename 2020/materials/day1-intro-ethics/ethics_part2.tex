...
\begin{center}
\includegraphics[width=\textwidth]{figures/ethics_schematic_simple}
\end{center}
...
\begin{itemize}
\item \onslide<1>{Simple idea: informed consent for all research}
\item \onslide<2>{\sout{Simple idea: informed consent for all research}}
\item \onslide<2>{Actual rules and principles: some form of consent for most research}
\end{itemize}
...
\pause
\item Ideas for alternatives in \href{https://www.bitbybitbook.com/en/1st-ed/ethics/dilemmas/consent/}{\texit{Bit by Bit}, Sec 6.6.1}
\end{itemize}
...
\begin{itemize}
\item \onslide<1>{Simple idea: Public/private dichotomy}
\item \onslide<2>{\sout{Simple idea: Public/private dichotomy}}
\item \onslide<2>{Better idea: contextual integrity (Nissenbaum), think about flows of information}
\end{itemize}
...
\vfill
\pause
\onslide<2>{For fuller elaboration, see \href{https://www.bitbybitbook.com/en/1st-ed/ethics/dilemmas/uncertainty/}{\textit{Bit by Bit}, Sec 6.6.3}
...
\begin{itemize}
\item \onslide<1>{Simple idea: Better safe than sorry (``precautionary principle'')}
\item \onslide<2>{\sout{Simple idea: Better safe than sorry (``precautionary principle'')}}
\item \onslide<2>{Better idea: There is no risk free approach, and we should not take a narrow-field of view}
\end{itemize}

\vfill
\onslide<2>{For fuller elaboration, see Sunstein (2005) \href{https://www.amazon.com/Laws-Fear-Precautionary-Principle-Lectures/dp/0521615127}{Laws of Fear: Beyond the Precautionary Principle}}
\end{frame}
%%%%%%%%%%%%%%%%%%%%%%%%%%%
\begin{frame}
