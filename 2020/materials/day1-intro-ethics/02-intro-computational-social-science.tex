...
\begin{center}
\includegraphics[width=\textwidth]{figures/blumenstock_predicting_2015_fig2}
\end{center}

\vfill
\TINY{Blumenstock et al. (2015), Figure 2}
...
\begin{center}
\only<1>{\includegraphics[width=\textwidth]{figures/blumenstock_predicting_2015_fig3a}}
\only<2-3>{\includegraphics[width=\textwidth]{figures/blumenstock_predicting_2015_fig3ab}}
\end{center}
\vspace{-0.2in}
\hspace{0.2in}Blumenstock et al.\ \hspace{0.7in} \onslide<2-3>Demographic \& Health Survey\\ 
...
\end{itemize}
{\TINY Blumenstock et al. (2015), Figure 3}
...
\begin{center}
\includegraphics[width=0.8\textwidth]{figures/bitbybit1-1a_hilbert_worlds_2011_fig2}
\end{center}

\vf
\Tiny{\textit{Bit by Bit}, Fig 1.1, based on Hilbert and L\`{o}pez (2011)}
...
\begin{center}
\LARGE{How do we create a computational social science community?}
\end{center}
...
\begin{itemize}
\item Data science alone is not enough if we want to study social behavior
\pause
