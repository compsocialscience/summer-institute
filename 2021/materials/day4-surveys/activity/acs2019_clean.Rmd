...
acs <- acs %>% select(REGION,PERWT,AGE,EDUC,SEX,HISPAN,RACE)
# rename variables
colnames(acs) <- c("region", "perwt", "age", "educ", "sex", "hisp", "race")
...
acs <- acs %>% mutate(sex = recode(sex, `1`="Male", `2`="Female"),
                      educ = recode(educ,
                                    ...
                                    `7` = "some college or associate's degree", `8`= "some college or associate's degree", 
                                    `9`="some college or associate's degree", 
                                    `10`="bachelor's degree", 
                                    `11`="postgraduate or professional degree",
