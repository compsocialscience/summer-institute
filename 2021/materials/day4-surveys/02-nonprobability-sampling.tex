...
%%%%%%%%%%%%%%%%%%%%%%%%%%
\title[]{\textcolor{gray}{[Survey research in the digital age],} [Probability and non-probability sampling], \textcolor{gray}{[Computer-administered interviews], [Combining surveys and big data], [Additions and extensions]}}
...
\item You stand outside Lewis Library and recruit a non-random sample of 60 Princeton students
\item Males (n= 20): Average height: 180cm
\item Females (n=40): Average heigh: 170cm
\end{itemize}
\textcolor{green}{What is your estimate of the average height?}
...
\begin{itemize}
\item weighted estimate uses auxiliary information and assumptions
\pause
\item How could this go wrong?
\end{itemize}
...
\begin{center}
\includegraphics[width=0.3\textwidth]{figures/xboxlogo}
\end{center}

\vfill
\href{https://doi.org/10.1016/j.ijforecast.2014.06.001}{Wang et al (2015)}
\end{frame}
%%%%%%%%%%%%%%%%%%%%%%%%%%%
\begin{frame}
