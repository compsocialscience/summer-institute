...
JSON files can be nested several layers depp. For the guardian API, article data is returned under the key `results`, which in turn has to be accessed through `response` (see documentation).
