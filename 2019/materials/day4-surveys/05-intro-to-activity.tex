...
\date[]{Summer Institute in Computational Social Science\\June 20, 2019
\vfill
\begin{flushleft}
{\scriptsize
...
\pause
\item De-identify and open-source data (but remember to think about the end at the beginning)
\end{itemize}
