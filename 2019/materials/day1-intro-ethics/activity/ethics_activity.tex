...
\thispagestyle{empty}
\footnotetext[1]{We thank Don Green for advice that helped improve this activity.  This activity is based on a similar activity in Chapter 6 of~\citet{salganik_bit_2018} and based on an activity from SICSS 2017, which was authored by Matthew Salganik and Yo-Yo Chen.}
