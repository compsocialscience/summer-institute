...
# Copy and paste the line below into your console to quickly load the `findingk` object:
# load("./2019/materials/day3-text-analysis/topic-modeling/rmarkdown/findingk.Rda")
