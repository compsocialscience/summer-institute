...
From August 4 to August 15, 2025 the [Cyber Policy Center](https://cyber.fsi.stanford.edu/) and [Social Media Lab](https://sml.stanford.edu/) will host a Summer Institute in Computational Social Science at Stanford University (SICSS-Stanford) with generous support from the [Stanford Digital Economy Lab](https://digitaleconomy.stanford.edu/) and event space graciously provided by the [Haas Center for Public Service](https://haas.stanford.edu/). The purpose of the Summer Institute is to bring together graduate students, postdoctoral researchers, faculty, and others interested in computational social science. The Summer Institute is for both social scientists (broadly conceived) and data scientists (broadly conceived).
